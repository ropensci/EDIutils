...
#'
#' @description Create Event Subscription creates a new event subscription.
#'
#' @param path
...
#'     
#' @details POST : https://pasta.lternet.edu/package/event/eml
#' @export
#' @examples 
#'
create_event_subscription <- function(path, package.id, environment, user.id, user.pass,
                       affiliation){
