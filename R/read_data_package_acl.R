...
#' @details GET : https://pasta.lternet.edu/package/acl/eml/{scope}/{identifier}/{revision}
#' @export
#' @examples 
#'
read_data_package_acl <- function(package.id, environment = 'production'){
