...
#'
#' @description Returns an XML-formatted list that summarizes all the successful reads (total reads and non-robot reads) for all the resources of a given PASTA package ID, where a package ID is of the format “scope.identifier.revision”.
#'
#' @param attr.name
...
#'     }
#' @details GET : https://pasta.lternet.edu/audit/reads/{scope}/{identifier}/{revision}
#' @export
#' @examples 
#' # Using curl to list resource reads for package identifier “knb-lter-nwk.3120.2”.:
#'
get_packageid_reads <- function(attr.name, package.id, environment = "production"){
