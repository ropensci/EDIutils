...
#' @details GET : https://pasta.lternet.edu/package/report/acl/eml/{scope}/{identifier}/{revision}
#' @export
#' @examples 
#'
read_data_package_report_acl <- function(package.id, environment = 'production'){
