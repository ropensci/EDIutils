#' List recent uploads
#'
#' @description List Recent Uploads operation, optionally specifying the upload type (“insert” or “update”) and a maximum limit as query parameters in the URL. (See example below.)
#'
#' @param type
