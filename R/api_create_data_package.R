...
#'
#' @usage api_create_data_package(path, package.id, environment, user.id, user.pass,
#'     affiliation)
#'
#' @param path
...
api_create_data_package <- function(path, package.id, environment, user.id, user.pass,
                       affiliation){
