#' Get audit count
#'
#' @description Returns a count of the number of audit records matching the query parameters as specified in the request.
#'
#' @param attr.name
...
#'     }
#' @details GET : https://pasta.lternet.edu/audit/count
#' @export
#' @examples 
#'
get_audit_count <- function(attr.name, package.id, environment = "production"){
