#' Create audit record
#'
#' @description Creates a new logged entry in the Audit Manager’s logging database.
#'
#' @param path
...
#'     
#' @details POST : https://pasta.lternet.edu/audit
#'
#' @export
#' 
#' @examples 
#'
create_audit_record <- function(path, package.id, environment, user.id, user.pass,
                       affiliation){
