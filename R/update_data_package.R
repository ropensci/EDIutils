...
#'
#' @details PUT : https://pasta.lternet.edu/package/eml/{scope}/{identifier}
#'
#' @export
#' 
#' @examples 
#'
update_data_package <- function(path, package.id, environment, user.id, user.pass,
                       affiliation){
