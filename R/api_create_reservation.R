...
#'     is required.
#'
#' @usage api_create_reservation(scope, environment, user.id, user.pass, affiliation)
#'
#' @param scope
...
api_create_reservation <- function(scope, environment, user.id, user.pass, affiliation){
