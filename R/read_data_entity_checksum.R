...
#'
#' @description Read Data Entity Checksum operation, specifying the scope, identifier, revision, and entity identifier of the data entity object whose checksum is to be read in the URI, returning a 40-character SHA-1 checksum value.
#'
#' @param package.id
...
#' @examples 
#'
read_data_entity_checksum <- function(package.id, identifier, environment = 'production'){
