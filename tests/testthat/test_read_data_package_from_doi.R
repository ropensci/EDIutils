...
# Note: DOIs resolve to the production environment, which is incompatible with
# CI workflows relying on a staging-specific API token. This test is commented out
# for now and may be re-enabled in the future.
#
