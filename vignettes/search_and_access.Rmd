...
_See the [emld](https://cran.r-project.org/web/packages/emld/index.html) library for more on working with EML as a list or JSON-LD. See the [xml2](https://cran.r-project.org/web/packages/xml2/index.html) library for working with EML as XML._
