...
Exclude landsat and ecotrends

LTER sites publish data under unique scopes

Other projects group with unique keywords

#### Access

Downloaded data objects in raw bytes and parse with your favorite reader.
_Demonstrate with diverse object data package (tables, spatial, unusual format)_
...
Physical descriptions of data entities help with reading less common structures ...
