---
title: "Retrieving dataset citation stats"
author: "Corinna Gries"
date: "2021-11-05"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Retrieving dataset citation stats}
...
This vignette demonstrates how to query PASTA for journal articles that cite a certain dataset. These stats may be used in reports.
...
Get all revisions for each identifer and retrieve journal citations for each
...
The list of `citation_dois` now contains all journal publication DOIs that have cited a dataset in the EDI scope (on 11/5/2021).
