...
The EDIutils package provides R wrappers to the EDI data repository API functions. 
...
Several EDI REST API functions return XML, `xml2` is a convenient package to extract desired information and to save returned EML files locally.
